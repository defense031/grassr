...
- **`delta`** is the cross-coefficient percentile spread in pp across
  ...
  ICC excluded by construction). Below 9.25 the panel is *aligned* and
  one coefficient is safe to cite. Above 11.75 the panel is
  *divergent* and the panel-aggregate is suppressed in favor of the
  pairwise PABAK matrix and per-rater pooled-reference Se/Sp.
